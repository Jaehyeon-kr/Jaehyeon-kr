...
| 악성 URL 분류 | Dacon | Binary Classification | 🛠 **25/ -** (상위 -%) | 리더 | 진행중 |
| 채무 불이행 여부 예측 | Dacon | Binary Classification | 🛠 ** 42 / -** (상위 -%) | 리더 | 진행중 |
| Rainfall Prediction | Kaggle | Binary Classification | 🛠 **1000/2000** (상위 50%) | 리더 | 진행중 |
